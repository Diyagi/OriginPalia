...
public:
	...
	std::vector<FLocation> TeleportLocations = {
		...
		{ "Village_Root", ELocation::Kilima_WimsFishingSpot, "[Kilima] Wims Secret Fishing Spot", FVector(58217.884f, 41798.154f, -452.593f), FRotator(0.000f, 94.089f, 0.000f)},
		// Bahari Entrances
	...
	bool bVariousMovementTests = false;
	bool bProjectNavMeshWalking = false;
